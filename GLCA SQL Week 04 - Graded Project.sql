...
select length from film where film_id not in
(select rental_id from rental) order by length desc limit 1;
...
# 16. Create a view based on rental information consisting 
# of visiting_day, customer_name, the title of the film, 
# no_of_rental_days, the amount paid by the customer along 
# with the percentage of customer spending. (4 Marks)
